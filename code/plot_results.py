...
mse_df['Source'] = 'Original'
merged_mse_df['Source'] = 'Merged'
naive_mse_df['Source'] = 'Naive'
...
for i, feature in enumerate(features):
    ...
    sns.boxplot(x='Node ID', y='MSE', hue='Source', data=combined_df[combined_df['Feature'] == feature], ax=axes[i])
